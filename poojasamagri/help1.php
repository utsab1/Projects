	...
	<div class="faqs-w3l">
		<div class="container">
			...
			<div class="faq-w3agile">
				<h5>Top 4 Frequently asked questions</h5>
				<ul class="faq">
					<li class="item1">
						<a href="#" title="click here">Why test1 ?</a>
						<ul>
							<li class="subitem1">
								<p> test</p>
							</li>
					...
					<li class="item2">
						<a href="#" title="click here">How test 2?</a>
						<ul>
							<li class="subitem1">
								<p> Test2</p>
							</li>
					...
					<li class="item3">
						<a href="#" title="click here">When test3</a>
						<ul>
							<li class="subitem1">
								<p>Test3</p>
							</li>
					...
					<li class="item4">
						<a href="#" title="click here">What test 5?</a>
						<ul>
							<li class="subitem1">
								<p>Test 4</p>
							</li>
